...
//
// p: player position
// b: is platforms positions
//
// t: is platform type
///////// t:4 - finish touch block
///////// t:8 - basic standard floor
...
$.level = [
  //level 0
      {
            p: { x: 350, y: 670 },
            b: [{ x: 265, y: 800, t: 8, w: 640, h: 40 }, { x: 675, y: 412, t: 4 }]
      },
  //level 1
      {//jumper tutorial
            p: { x: 600, y: 1100 },
            b: [{ x: 0, y: 1235, t: 8, w: 1250, h: 40 }, { x: 261, y: 967, t: 0 }, { x: 921, y: 389, t: 0 }, { x: 579, y: 682, t: 0 }, { x: 206, y: 73, t: 4 }]
      },
  //level 2
  ...
  //level 6?
      {//needs to be moved higher - 11
            p: { x: 600, y: 630 },
            b: [{ x: -50, y: -1350, t: 9 }, { x: 1150, y: -1350, t: 9 }, { x: 100, y: 500, t: 0 }, { x: 200, y: 700, t: 2 }, { x: 100, y: -100, t: 2 }, { x: 300, y: -400, t: 0 }, { x: 100, y: -900, t: 1 }, { x: 700, y: -1100, t: 4 }, { x: -50, y: 750, t: 8, w: 1250, h: 40 }]
      },
...
$.tutorial = [
      ["You must get through this hell!", "Quickly get me to the green finish.", "The faster you are, the more points you'll receive!", $.ios ? "Use the left half of the screen to move left or right" : "Left and right arrows make me move.", $.ios ? "Use the right half of the screen to jump" : "Space makes me jump and enter restarts me.", "Let's go! Time's a wasting up there!"],//level 0
      ["This time we have bouncy platforms.", "Hurry! Jump on them and find the finish."], //level 1
      ["Floating ground, hmm?", "I can't jump through these.", "And that ice looks slippery."], //level 1
      ["Padded walls?!? Do I look like I am crazy?", "Maybe I can climb them?"],
...
$.player.prototype.success = function () {
    ...
    $.state.nextLevel();
    $.util.popChat(window.innerWidth / 2, ($.H / 2.5)-25, ["Yaaay!!!! Well done!!"]);
